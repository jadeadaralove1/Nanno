export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastdaily) {
      ...
      return m.reply(`𐄹 ۪ ׁ 🪙ᩚ̼ 𖹭̫ ▎Ya has reclamado tu *Daily* de hoy.\n> Puedes reclamarlo de nuevo en *${restante}*`)
    }
    ...
    await m.reply(`𐄹 ۪ ׁ 🪙ᩚ̼ 𖹭̫ ▎Has reclamado tu recompensa diaria de *¥${recompensa.toLocaleString()} ${monedas}*! (Día *${users.streak}*)\n${msg}`)
  },
}
