export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastmonthly) {
      ...
      return client.sendMessage(m.chat, { text: `𐄹 ۪ ׁ 🪙ᩚ̼ 𖹭̫ ▎ Ya has reclamado tu recompensa mensual.\n> Puedes reclamarlo de nuevo en *${wait}*` }, { quoted: m })
    }
    ...
    await client.sendMessage(m.chat, { text: `𐄹 ۪ ׁ 🪙ᩚ̼ 𖹭̫ ▎ Has reclamado tu recompensa mensual de *+${coins.toLocaleString()} ${currency}* (Mes *${users.monthlyStreak}*)\n${msg}` }, { quoted: m })
  }
}
