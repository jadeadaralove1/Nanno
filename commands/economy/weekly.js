export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastweekly) {
      ...
      return client.reply(m.chat, `𐄹 ۪ ׁ 🪙ᩚ̼ 𖹭̫ ▎ Ya has reclamado tu recompensa semanal.\n> Puedes reclamarlo de nuevo en *${wait}*`, m)
    }
    ...
    client.reply(m.chat, `𐄹 ۪ ׁ 🪙ᩚ̼ 𖹭̫ ▎ Has reclamado tu recompensa semanal de *¥${coins.toLocaleString()} ${currency}* (Semana *${users.weeklyStreak}*)\n${msg}`, m)
  }
}
