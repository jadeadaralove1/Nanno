...
𐐗𐐗ㅤㅤㅤ🌸ᩨ⃨  :: El grupo ya estaba cerrado… pero no te preocupes.

> Las cosas más interesantes… empiezan cuando ya no hay salida.`, m)
      }
...
> 𐐗𐐗ㅤㅤㅤ💉ᩨ⃨  ::  Cerrado correctamente… ahora empieza lo interesante.`, m)
      }
      if (timeout > 0) {
        await client.reply(m.chat, `𐄹 ۪ ׁ 🤖ᩚ̼ 𖹭̫ ▎ El grupo se cerrará en ${clockString(timeout)}.`, m)
        setTimeout(async () => {
          try {
