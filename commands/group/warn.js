...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    try {
      if (!who2) return m.reply('𐄹 ۪ ׁ 🥀ᩚ̼ 𖹭̫ ▎ Debes mencionar o responder al usuario que deseas advertir.')
      ...
      let message = `𐄹 ۪ ׁ 😺ᩚ̼ 𖹭̫ ▎ Se ha añadido una advertencia a @${targetId.split('@')[0]}.\n> ♡ Advertencias totales \`(${total})\`:\n\n${warningList}`
