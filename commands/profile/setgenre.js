export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    if (!input) return m.reply(`𐄹 ۪ ׁ 🤖ᩚ̼ 𖹭̫ ▎ Debes ingresar un género válido.\n> Ejemplos:\n> *${usedPrefix + command} hombre*\n> *${usedPrefix + command} mujer*`)
    ...
    if (!genre) {
      ...
      return m.reply(`𐄹 ۪ ׁ 🤖ᩚ̼ 𖹭̫ ▎ Elije un género válido.\n\nOpciones:\n${opciones}`)
    }
    user.genre = genre
    return m.reply(`𐄹 ۪ ׁ 🤖ᩚ̼ 𖹭̫ ▎ Se ha establecido tu género como: *${user.genre}*`)
  },
}