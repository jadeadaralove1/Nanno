...
client.sendMessage(m.chat, { text: `𐄹 ۪ ׁ ⚠️ᩚ̼ 𖹭̫ ▎ Has conectado un nuevo Socket de tipo *Gratuito*.` }, { quoted: m })
...
try {
let codeGen = await sock.requestPairingCode(phone, 'NANNOBOT');
