...
function initDB(m, client) {
  ...
  settings.nameid ??= "Nanno bot"
  settings.type ??= 'Owner'
  settings.link ??= 'https://whatsapp.com/channel/0029VbBvrmwC1Fu5SYpbBE2A'
  settings.banner ??= 'https://causas-files.vercel.app/fl/f8do.jpg'
  settings.icon ??= 'https://files.catbox.moe/f1xk4x.jpg'
  settings.currency ??= 'NannoCoins'
  settings.namebot ??= 'Nanno'
  settings.botname ??= 'Nanno bot'  
  settings.owner ??= ''
